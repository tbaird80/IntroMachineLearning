...
if __name__ == '__main__':
    '''
    This is our main function for the Computer Hardware test set. It will define, tune, and test the set to return an effectiveness
    ...
    tuningMap = {'p': [1, 2], 'k': [5, 7, 10], 'e': [5, 10, 15], 's': [1, 2]}
